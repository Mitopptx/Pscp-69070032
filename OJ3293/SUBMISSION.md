...
```text
input 5 string and crop it with ****** to make a frame
---
...
```text
step 1: Input 5 strings and store them in a list.
step 2: Find the longest string to determine the frame size.
step 3: Print the strings inside a `*` frame, adding spaces to align them.
```
